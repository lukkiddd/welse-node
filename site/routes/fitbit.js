...
router.get('/authorize',  (req, res) => {
	...
	res.redirect(client.getAuthorizeUrl('activity sleep', 'https://welse-taiwan.azurewebsites.net/api/fitbit/callback', 'none', id))
});

router.get('/callback', (req, res) => {
	const _id = req.query.state;
	client.getAccessToken(req.query.code, 'https://welse-taiwan.azurewebsites.net/api/fitbit/callback')
		.then( async (result) => {
			...
			res.redirect('https://welse-taiwan.azurewebsites.net');
